...
import { DatabaseQuery } from '../../../../application/contracts/database';
 ...
 */
export class DatabaseQueryCircuitBreakerProxy implements DatabaseQuery {
  ...
  async query(input: DatabaseQuery.Input): Promise<DatabaseQuery.Output> {
